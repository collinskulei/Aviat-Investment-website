    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#3a4a5c] via-[#141c26] to-background">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-28 sm:py-36">
          <h1 className="max-w-2xl text-4xl font-extrabold leading-tight sm:text-5xl">
            ...
            <br />
            <span className="text-accent">for Aviation Safety.</span>
          </h1>
          ...
          <p className="mt-2 max-w-xl font-medium text-accent">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link
              href="/services"
              className="rounded-lg border border-white/30 bg-white/10 px-6 py-3 text-sm font-semibold text-foreground backdrop-blur transition-colors hover:bg-white/20"
            >
              VIEW OUR SERVICES
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="relative overflow-hidden rounded-2xl border border-card-border bg-gradient-to-br from-[#2a3a4d] via-[#0f1620] to-black px-8 py-20 text-center">
          ...
          <h2 className="relative mx-auto mt-3 max-w-2xl text-2xl font-bold sm:text-3xl">
